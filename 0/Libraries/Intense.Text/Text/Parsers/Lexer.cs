    ...
    public abstract class Lexer
    {
        ...
        private static void ValidateOccurence(int count, int minOccurs, int maxOccurs)
        {
            if (count < minOccurs || count > maxOccurs) {
                throw new ParseException(ResourceHelper.GetString("InvalidCharacterCount"));
            }
        }
        ...
        protected void Match(char value)
        {
            if (LA(1) == value) {
                ...
                throw new ParseException(ResourceHelper.GetString("CharacterMismatch"));
            }
        }
        ...
        protected void Match(string value)
        {
            ...
            for (int i = 0; i < value.Length; i++) {
                if (LA(1) == value[i]) {
                    ...
                    throw new ParseException(ResourceHelper.GetString("StringMismatch"));
                }
            }
        }
